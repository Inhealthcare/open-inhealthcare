 ...
 *  
 */
public class GetPatientDetailsOperationUnitTest2 extends TestCase {
	...
	public void testValidationNhsNumber() throws ConfigurationException, LoggingException {
		...
		// Invalid - Missing - DONT DO IN THIS CASE - GPD will only go down this path if there is an NHS Number
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsOperation.NHSERROR_PREFIX));
		}
	...
	public void testValidationDOB() throws ConfigurationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsOperation.DOBERROR_PREFIX));
		}
		// Invalid - Blank
	...
	public void testValidationSurname() throws ConfigurationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsOperation.SURNAMEERROR_PREFIX));
		}
	...
	public void testValidationGivenName() throws ConfigurationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsOperation.GIVENNAMEERROR_PREFIX));
		}
	...
	public void testITKSend() throws ConfigurationException, LoggingException, ValidationException{
		...
		try {
			...
			// Check the payload
			String dob = XPaths.compileXPath("/hl7:getPatientDetails-v1-0/hl7:queryEvent/hl7:Person.DateOfBirth/hl7:value/@value").evaluate(vnnRequestDoc);
			assertTrue(dob.equals(VALID_DOB));
			String given = XPaths.compileXPath("/hl7:getPatientDetails-v1-0/hl7:queryEvent/hl7:Person.Name/hl7:value/hl7:given").evaluate(vnnRequestDoc);
			assertTrue(given.equals(VALID_GIVENNAME));
			String surname = XPaths.compileXPath("/hl7:getPatientDetails-v1-0/hl7:queryEvent/hl7:Person.Name/hl7:value/hl7:family").evaluate(vnnRequestDoc);
			assertTrue(surname.equals(VALID_SURNAME));
			String nhsNumber = XPaths.compileXPath("/hl7:getPatientDetails-v1-0/hl7:queryEvent/hl7:Person.NHSNumber/hl7:value/@extension").evaluate(vnnRequestDoc);
