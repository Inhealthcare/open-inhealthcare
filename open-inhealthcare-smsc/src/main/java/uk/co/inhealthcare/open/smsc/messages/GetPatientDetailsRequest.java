...
public class GetPatientDetailsRequest extends SMSPRequest {
	...
	private final static Logger logger = LoggerFactory
			.getLogger(GetPatientDetailsRequest.class);
	...
	public String serialise() {
		...
		XML += "<LocalPatientIdentifier>"
				+ getSafeString(localPatientIdentifier)
	...
	public GetPatientDetailsRequest(String conversationId) {
