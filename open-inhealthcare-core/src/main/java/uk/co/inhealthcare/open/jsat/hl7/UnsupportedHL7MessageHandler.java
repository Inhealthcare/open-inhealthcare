...
public class UnsupportedHL7MessageHandler {

	private final static Logger logger = LoggerFactory.getLogger(UnsupportedHL7MessageHandler.class);
	
	public UnsupportedHL7MessageHandler(){
		logger.debug("Starting Unknown Processor.");
	}
	
	public void onMessage(Message hl7Msg) {
