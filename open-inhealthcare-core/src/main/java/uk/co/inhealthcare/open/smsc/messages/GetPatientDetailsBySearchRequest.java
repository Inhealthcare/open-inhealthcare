...
/**
 * The Class GetPatientDetailsBySearchRequest.
 *
 * @author Nick Jones
 * @since 0.1
 */
public class GetPatientDetailsBySearchRequest extends SMSPRequest {

	private final static Logger logger = LoggerFactory.getLogger(GetPatientDetailsBySearchRequest.class);
	...
	public String serialise(){
		...
		try {
			...
			logger.error("Error creating GPDBS Request.",e);
		}
	 ...
	 */
	public GetPatientDetailsBySearchRequest(DemographicUpdate update, String conversationId){
		...
		this.postcode = update.getPostcode();
	 ...
	 * Instantiates a new GetPatientDetailsBySearchRequest
	 */
	public GetPatientDetailsBySearchRequest(){
		super();
	}
