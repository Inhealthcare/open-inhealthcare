 ...
 * @since 0.1
 */
public class GetPatientDetailsRequest extends SMSPRequest {

	private final static Logger logger = LoggerFactory.getLogger(GetPatientDetailsRequest.class);
	 ...
	 */
	public GetPatientDetailsRequest(DemographicUpdate update, String conversationId){
