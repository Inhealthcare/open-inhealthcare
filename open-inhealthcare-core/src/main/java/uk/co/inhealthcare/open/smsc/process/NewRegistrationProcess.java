 ...
 *
 */
public class NewRegistrationProcess extends SMSCProcess {

	private final static Logger logger = LoggerFactory.getLogger(NewRegistrationProcess.class);
	
	// INJECTED DEPENDENCIES
	private GetPatientDetailsBySearchOperation getPatientDetailsBySearchOperation;
	private GetPatientDetailsByNHSNumberOperation getPatientDetailsByNHSNumberOperation;
	//
	
	public NewRegistrationProcess(){
	...
	protected String processDetail(DemographicUpdate update, MessageProperties props) 
		...
		try {
			if (update.getNHSNumber().length()==0){
				// No NHS Number provided - perform Get Patient Details By Search
				logger.debug("Performing Get Patient Details By Search");
				GetPatientDetailsBySearchRequest getPatientDetailsBySearchReq = new GetPatientDetailsBySearchRequest(update, props.getConversationId());
				getPatientDetailsBySearchReq.setLocalAuditId(this.localAuditId);
				smspResponse = getPatientDetailsBySearchOperation.process(getPatientDetailsBySearchReq);
			} else {
				// NHS Number provided - perform Get Patient Details By NHS Number
				logger.debug("Performing Get Patient Details By NHS Number");
				GetPatientDetailsByNHSNumberRequest getPatientDetailsByNHSNumberReq = new GetPatientDetailsByNHSNumberRequest(update, props.getConversationId());
				getPatientDetailsByNHSNumberReq.setLocalAuditId(this.localAuditId);
				smspResponse = getPatientDetailsByNHSNumberOperation.process(getPatientDetailsByNHSNumberReq);
			}
	...
	public void setGetPatientDetailsByNHSNumberOperation(GetPatientDetailsByNHSNumberOperation getPatientDetailsByNHSNumberOperation) {
		logger.debug("Setting GetPatientDetailsByNHSNumberOperation to:"+getPatientDetailsByNHSNumberOperation);
		this.getPatientDetailsByNHSNumberOperation = getPatientDetailsByNHSNumberOperation;
	}
	public void setGetPatientDetailsBySearchOperation(GetPatientDetailsBySearchOperation getPatientDetailsBySearchOperation) {
		logger.debug("Setting GetPatientDetailsBySearchOperation to:"+getPatientDetailsBySearchOperation);
		this.getPatientDetailsBySearchOperation = getPatientDetailsBySearchOperation;
	}
