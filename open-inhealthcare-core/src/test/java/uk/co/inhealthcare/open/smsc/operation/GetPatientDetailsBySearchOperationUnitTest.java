...
import uk.co.inhealthcare.open.smsc.operation.GetPatientDetailsBySearchOperation;

/*
 * Unit
 * - This operation
 * - Related Messages (GetPatientDetailsBySearchRequest/Response)
 * - Superclass Hierarchy
 * 
 * Responsibilities
 * - Accept a GetPatientDetailsBySearchRequest
 ...
 * - Value: serviceId (e.g. "urn:nhs-itk:services:201005:getPatientDetailsBySearch-v1-0") [Mandatory]
 * - Value: profileId (e.g. "urn:nhs-en:profile:getPatientDetailsBySearchRequest-v1-0") [Mandatory]
 * - Value: sender (e.g. "urn:nhs-uk:addressing:ods:XXXX:JSAT") [Mandatory]
 * - Value: toPayloadTransform (e.g. "xslt/smsc/ToGetPatientDetailsBySearchRequest.xslt") [Mandatory]
 * 
 * Mocks Required
 ...
 *  
 */
public class GetPatientDetailsBySearchOperationUnitTest extends TestCase {
	...
	private static final String SERVICEID = "urn:nhs-itk:services:201005:getPatientDetailsBySearch-v1-0";
	private static final String PROFILEID = "urn:nhs-en:profile:getPatientDetailsBySearchRequest-v1-0";
	private static final String SENDER = "urn:nhs-uk:addressing:ods:XXXX:JSAT";
	private static final String TOPAYLOADTRANSFORM = "xslt/smsc/ToGetPatientDetailsBySearchRequest.xslt";

	// TEST CONFIGURATION

	public void testConfigMissingITKMessageSender() throws ValidationException, LoggingException {
		
		GetPatientDetailsBySearchOperation operation = getConfiguredOperation();
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsBySearchOperation.ITKMESSAGESENDER_NOT_CONFIGURED));
		}
	}
	...
	public void testConfigMissingServiceProvider() throws ValidationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsBySearchOperation.SERVICEPROVIDER_NOT_CONFIGURED));
		}
	}
	...
	public void testConfigMissingServiceId() throws ValidationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsBySearchOperation.SERVICEID_NOT_CONFIGURED));
		}
	}
	...
	public void testConfigMissingProfileId() throws ValidationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsBySearchOperation.PROFILEID_NOT_CONFIGURED));
		}
	}
	...
	public void testConfigMissingSender() throws ValidationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsBySearchOperation.SENDER_NOT_CONFIGURED));
		}
	}
	...
	public void testConfigMissingToPayloadTransform() throws ValidationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsBySearchOperation.TOPAYLOADTRANSFORM_NOT_CONFIGURED));
		}
	}
	...
	public void testConfigMissingSMSCLogger() throws ValidationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsBySearchOperation.SMSCLOGGER_NOT_CONFIGURED));
		}
	}
	...
	public void testParmsMissingRequest() throws ValidationException, LoggingException {
		...
		try {
			...
			assertTrue(e.getMessage().contains(GetPatientDetailsBySearchOperation.ERR_REQUEST_NOT_PROVIDED));
		}
	}
	...
	public void testRequestLoggingException() throws ConfigurationException, ValidationException {
		...
		GetPatientDetailsBySearchOperation operation = getConfiguredOperation();
		GetPatientDetailsBySearchRequest request = new GetPatientDetailsBySearchRequest();
	...
	public void testRequestLogging() throws ConfigurationException, LoggingException, ValidationException {
		...
		GetPatientDetailsBySearchOperation operation = getConfiguredOperation();
		GetPatientDetailsBySearchRequest request = getValidRequest();
	...
	public void testITKSend() throws ConfigurationException, LoggingException, ValidationException{
		...
		try {
			...
			// Check the payload
			String dob = XPaths.compileXPath("/hl7:getPatientDetailsBySearchRequest-v1-0/hl7:queryEvent/hl7:Person.DateOfBirth/hl7:value/@value").evaluate(gpdbsRequestDoc);
			assertTrue(dob.equals(VALID_DOB));
			String gender = XPaths.compileXPath("/hl7:getPatientDetailsBySearchRequest-v1-0/hl7:queryEvent/hl7:Person.Gender/hl7:value/@code").evaluate(gpdbsRequestDoc);
			assertTrue(gender.equals(VALID_GENDER));
			String given = XPaths.compileXPath("/hl7:getPatientDetailsBySearchRequest-v1-0/hl7:queryEvent/hl7:Person.Name/hl7:value/hl7:given").evaluate(gpdbsRequestDoc);
			assertTrue(given.equals(VALID_GIVENNAME));
			String surname = XPaths.compileXPath("/hl7:getPatientDetailsBySearchRequest-v1-0/hl7:queryEvent/hl7:Person.Name/hl7:value/hl7:family").evaluate(gpdbsRequestDoc);
			assertTrue(surname.equals(VALID_SURNAME));
			String postcode = XPaths.compileXPath("/hl7:getPatientDetailsBySearchRequest-v1-0/hl7:queryEvent/hl7:Person.Postcode/hl7:value/hl7:postalCode").evaluate(gpdbsRequestDoc);
	...
	// UTILS
	private GetPatientDetailsBySearchOperation getConfiguredOperation(){
		GetPatientDetailsBySearchOperation operation = new GetPatientDetailsBySearchOperation();
	...
	private GetPatientDetailsBySearchRequest getValidRequest(){
		GetPatientDetailsBySearchRequest request = new GetPatientDetailsBySearchRequest();
