 ...
 * @since 0.1
 */
public class SimpleProcessLoggingServiceImpl implements ProcessLoggingService {

	private final static Logger logger = LoggerFactory.getLogger(SimpleProcessLoggingServiceImpl.class);
	
	/** The Constant DATE_FORMAT. */
	private static SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss.SSS Z");
	
    public SimpleProcessLoggingServiceImpl(){
