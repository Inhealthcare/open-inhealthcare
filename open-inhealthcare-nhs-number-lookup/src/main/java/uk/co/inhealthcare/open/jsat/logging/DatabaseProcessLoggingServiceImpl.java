...
/**
 * The Class ITKSimpleAudit. This class is a fallback to audit to the current
 * log file when there is no Audit Service defined.
 *
 * @author Nick Jones
 * @since 0.1
 */
public class DatabaseProcessLoggingServiceImpl implements ProcessLoggingService {

	// private final static Logger logger =
	// LoggerFactory.getLogger(DatabaseSMSCLoggingServiceImpl.class);
	...
	public DatabaseProcessLoggingServiceImpl() {
	...
	@Override
	public void logSMSCProcessInput(String conversationId,
			DemographicUpdate demoUpdate) throws LoggingException {
		String timestamp = DATE_FORMAT.format(Calendar.getInstance().getTime());
