	...
	protected String processDetail(DemographicUpdate update, MessageProperties props) 
		...
		try {
			if (update.getNHSNumber().length()==0){
				...
				GetPatientDetailsBySearchRequest getPatientDetailsBySearchReq = update
						.createGetPatientDetailsBySearchRequest(props
								.getConversationId());
				...
				GetPatientDetailsByNHSNumberRequest getPatientDetailsByNHSNumberReq = update
						.createGetPatientDetailsByNHSNumberRequest(props
								.getConversationId());
